package com.amannmalik.workflow.operator.restate;
...
public class DurableWorkflowRunner {
    ...
    private static final Logger log = LoggerFactory.getLogger(DurableWorkflowRunner.class);
    ...
    public static void main(String[] args) {
        RestateHttpServer.listen(Endpoint.bind(new DurableWorkflowRunner()));
    }
}
